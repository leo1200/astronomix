...
echo "=== ISM_N512 START $(date) ==="
eval $(autocvd -q)
export CUDA_VISIBLE_DEVICES
echo "ISM_N512 using CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES"
...
echo "=== ICM_N512 START $(date) ==="
eval $(autocvd -q)
export CUDA_VISIBLE_DEVICES
echo "ICM_N512 using CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES"
python paper_turbulence.py \
...
echo "=== ICM_N512 EXIT ${PIPESTATUS[0]} $(date) ==="
echo "=== ALL DONE $(date) ==="

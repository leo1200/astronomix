...
# plot histograms of rho, |v|^2, |B|^2, P
fig, ((ax1, ax2), (ax3, ax4)) = plt.subplots(2, 2, figsize=(12, 10))

# Density histogram
ax1.hist(final_state[registered_variables.density_index].flatten(), bins=50, log=True, density=True)
ax1.set_title("Density Histogram")
ax1.set_xlabel("Density")
ax1.set_ylabel("Probability Density")

# Velocity magnitude squared histogram
v_mag_sq = final_state[registered_variables.velocity_index.x]**2 + \
           final_state[registered_variables.velocity_index.y]**2 + \
           final_state[registered_variables.velocity_index.z]**2
ax2.hist(v_mag_sq.flatten(), bins=50, log=True, density=True)
ax2.set_title("Velocity Magnitude Squared Histogram")
ax2.set_xlabel("|v|^2")
ax2.set_ylabel("Probability Density")

# Magnetic field magnitude squared histogram
b_mag_sq = final_state[registered_variables.magnetic_index.x]**2 + \
           final_state[registered_variables.magnetic_index.y]**2 + \
           final_state[registered_variables.magnetic_index.z]**2
ax3.hist(b_mag_sq.flatten(), bins=50, log=True, density=True)
ax3.set_title("Magnetic Field Magnitude Squared Histogram")
ax3.set_xlabel("|B|^2")
ax3.set_ylabel("Probability Density")

# Pressure histogram
ax4.hist(final_state[registered_variables.pressure_index].flatten(), bins=50, log=True, density=True)
ax4.set_title("Pressure Histogram")
ax4.set_xlabel("Pressure")
ax4.set_ylabel("Probability Density")

plt.tight_layout()
plt.savefig("figures/histograms" + app_string + ".png")
...
print(f"=== Two Parallel Shocks ({TARGET_SHOCK_ANGLE}°) ===")
...
fig.suptitle(f"Two Parallel Rotated Shocks ({TARGET_SHOCK_ANGLE}°) — Shock Finder Validation", fontsize=13)
...
axes[1, 2].set_title(f"Slice along normal (θ={TARGET_SHOCK_ANGLE}°)\nexpect 2 red lines + 2 green zones")

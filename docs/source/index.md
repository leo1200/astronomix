...
A high-order finite difference constrained transport WENO MHD scheme following [HOW-MHD by Seo & Ryu 2023](https://arxiv.org/abs/2304.04360) as well as the provably divergence free and provably positivity preserving
...
Physical modules for stellar winds, turbulent driving, ... can be activated or easily implemented. These modules can include parameters (or neural network terms) which can be optimized directly in the solver. Further primitive variables, like those for a [cosmic ray fluid](notebooks/cosmic_rays/simple_example_cr.ipynb), are already implemented or can be added.
...
resoltions was an MHD blast wave test.

| ![scaling comparison](figures/scaling_comparison.svg)    |
|:---------------------------------------------------------------------------------:|
...
| ![accuracy vs cost](figures/l2_error_comparisonH200.svg) |
|:---------------------------------------------------------------------------------:|
...
| ![multi gpu scaling](figures/scaling_speedup.svg) |
|:---------------------------------------------------------------------------------:|
...
| ![fv_mhd jet](figures/mhd_jet.png) |
|:---------------------------------------------------------------------------------:|
...
| ![fv_mhd oscillations](figures/fv_oscillations_comparison.png) |
|:---------------------------------------------------------------------------------:|
...
| ![energy conservation](figures/collapse_energy_evolution_comparison.svg) |
|:---------------------------------------------------------------------------------:|
...
| ![simple failure](figures/simple_failure_pressure_slices.png) |
|:---------------------------------------------------------------------------------:|
